  ...
  public void toAlgebraicTest() {
    ...
    assertEquals(
        ...
        pgnService.toAlgebraic(
            Pos.parseString("d2"), Pos.parseString("d4"), chessBoard, chessRules, null));
    assertEquals(
        "Bc4",
        pgnService.toAlgebraic(
            Pos.parseString("f1"), Pos.parseString("c4"), chessBoard, chessRules, null));
    assertEquals(
        "exf6",
        pgnService.toAlgebraic(
            Pos.parseString("e5"), Pos.parseString("f6"), chessBoard, chessRules, null));
    ...
    assertEquals(
        "Ncd5",
        pgnService.toAlgebraic(
            Pos.parseString("c3"), Pos.parseString("d5"), chessBoard, chessRules, null));

    // En passant test
    assertEquals(
        "cxb6 e.p.",
        pgnService.toAlgebraic(
            Pos.parseString("c5"), Pos.parseString("b6"), chessBoard, chessRules, null));
    ...
    assertEquals(
        "Rad2",
        pgnService.toAlgebraic(
            Pos.parseString("a2"), Pos.parseString("d2"), chessBoardPos2, chessRules, null));
    assertEquals(
        "Rhg2",
        pgnService.toAlgebraic(
            Pos.parseString("h2"), Pos.parseString("g2"), chessBoardPos2, chessRules, null));
    ...
    assertEquals(
        "O-O",
        pgnService.toAlgebraic(
            Pos.parseString("e1"), Pos.parseString("g1"), chessBoardPos3, chessRules, null));
    assertEquals(
        "O-O-O",
        pgnService.toAlgebraic(
            Pos.parseString("e1"), Pos.parseString("c1"), chessBoardPos3, chessRules, null));
